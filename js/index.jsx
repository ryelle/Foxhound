...
page( 'category/:term/page/:page', Controller.setup, Controller.navigation, Controller.termArchive );
page( 'tag/:term',                 Controller.setup, Controller.navigation, Controller.termArchive );
page( 'tag/:term/page/:page',      Controller.setup, Controller.navigation, Controller.termArchive );
