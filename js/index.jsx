...
page(/^(\d{4})\/(\d{2})\/(\d{2})\/?$/,                Controller.setupDate, Controller.navigation, Controller.dateArchive );
page(/^(\d{4})\/(\d{2})\/(\d{2})\/(page)\/(\d*)\/?$/, Controller.setupDate, Controller.navigation, Controller.dateArchive );
